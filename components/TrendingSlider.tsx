...
export const TrendingSlider: React.FC<TrendingSliderProps> = ({ items, onProductClick }) => {
  return (
      ...
      <HorizontalSlider itemWidth={300}>
        {items.map((product) => (
          ...
          >
            ...
            />
            {/* Hover Heart */}
            <button className="absolute top-3 right-3 p-2 bg-white rounded-full shadow-md opacity-100 hover:bg-gray-100 transition-opacity z-10">
