...
export const RoundCategoryGrid: React.FC<RoundCategoryGridProps> = ({ title, items }) => {
  return (
    <section className="max-w-[1560px] mx-auto px-5 md:px-16 lg:px-24 py-10">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-x-4 md:gap-x-6 gap-y-8">
        {items.map((item) => (
          <div key={item.id} className="group cursor-pointer flex flex-col items-center sm:items-start">
