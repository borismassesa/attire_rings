...
export const ProductCard: React.FC<ProductCardProps> = ({ product, showVideoIcon, variant = 'default' }) => {
  return (
    <div className="group cursor-pointer flex flex-col h-full w-full">
      ...
      <div className="relative w-full aspect-[4/3] rounded-[4px] sm:rounded-md overflow-hidden mb-2 bg-gray-100 border border-transparent hover:shadow-md transition-all">
        ...
        />
        <button className="absolute top-2 right-2 p-1.5 bg-white rounded-full text-gray-700 hover:bg-gray-100 opacity-0 group-hover:opacity-100 transition-opacity shadow-sm z-10">
          <Heart size={16} />
        </button>
