...
export const WINTER_CATEGORIES: Category[] = [
  { id: '1', title: 'Wedding Attire', image: 'https://images.unsplash.com/photo-1539008835657-9e8e9680c956?auto=format&fit=crop&q=80&w=400' },
  { id: '2', title: 'Engagement Rings', image: 'https://images.unsplash.com/photo-1605100804763-247f67b3557e?auto=format&fit=crop&q=80&w=400' },
  { id: '3', title: 'Event Decor', image: 'https://images.unsplash.com/photo-1519225421980-715cb0202128?auto=format&fit=crop&q=80&w=400' },
  { id: '4', title: 'Bridal Accessories', image: 'https://images.unsplash.com/photo-1595967784088-25fb524458bb?auto=format&fit=crop&q=80&w=400' },
  { id: '5', title: 'Groomsmen Suits', image: 'https://images.unsplash.com/photo-1507679799987-c73779587ccf?auto=format&fit=crop&q=80&w=400' },
  { id: '6', title: 'Custom Invitations', image: 'https://images.unsplash.com/photo-1586078310328-98e6c40683a4?auto=format&fit=crop&q=80&w=400' },
];
...
export const SPECIAL_GIFTS_ROW: Category[] = [
   { id: '1', title: "Engagement Rings", image: 'https://images.unsplash.com/photo-1605100804763-247f67b3557e?auto=format&fit=crop&q=80&w=200' },
   { id: '2', title: "Wedding Dresses", image: 'https://images.unsplash.com/photo-1594552072238-b8a33785b261?auto=format&fit=crop&q=80&w=200' },
   { id: '3', title: "Bridesmaid Dresses", image: 'https://images.unsplash.com/photo-1512767258384-a169b596144e?auto=format&fit=crop&q=80&w=200' },
   { id: '4', title: "Mother of the Bride", image: 'https://images.unsplash.com/photo-1569388330292-79cc1ec67270?auto=format&fit=crop&q=80&w=200' },
   { id: '5', title: "Wedding Rings", image: 'https://images.unsplash.com/photo-1599643478518-17488fbbcd75?auto=format&fit=crop&q=80&w=200' },
   { id: '6', title: "Suits & Tuxedos", image: 'https://images.unsplash.com/photo-1593032465175-481ac7f401a0?auto=format&fit=crop&q=80&w=200' },
];

// 5. Most Loved Departments
export const MOST_LOVED_CATEGORIES: Category[] = [
  { id: '1', title: 'Wedding Dresses', image: 'https://images.unsplash.com/photo-1595777457583-95e059d581b8?auto=format&fit=crop&q=80&w=400' },
  { id: '2', title: 'Suits & Tuxedos', image: 'https://images.unsplash.com/photo-1555069519-127a4643f301?auto=format&fit=crop&q=80&w=400' },
  { id: '3', title: 'Fine Jewelry', image: 'https://images.unsplash.com/photo-1515562141207-7a88fb7ce338?auto=format&fit=crop&q=80&w=400' },
  { id: '4', title: 'Traditional Wear', image: 'https://images.unsplash.com/photo-1606216794074-735e91aa2c92?auto=format&fit=crop&q=80&w=400' },
  { id: '5', title: 'Shoes', image: 'https://images.unsplash.com/photo-1580974852861-c381510bc98a?auto=format&fit=crop&q=80&w=400' },
  { id: '6', title: 'Event Planning', image: 'https://images.unsplash.com/photo-1511795409834-ef04bbd61622?auto=format&fit=crop&q=80&w=400' },
];
...
export const STANDOUT_STYLES: Category[] = [
  { id: '1', title: 'Bohemian Bridal', image: 'https://images.unsplash.com/photo-1502163140606-888448ae8cfe?auto=format&fit=crop&q=80&w=300' },
  { id: '2', title: 'Classic Tuxedos', image: 'https://images.unsplash.com/photo-1594938298603-c8148c4dae35?auto=format&fit=crop&q=80&w=300' },
  { id: '3', title: 'Vintage Jewelry', image: 'https://images.unsplash.com/photo-1600003014608-c2ccc136aa63?auto=format&fit=crop&q=80&w=300' },
  { id: '4', title: 'Flower Girl Dresses', image: 'https://images.unsplash.com/photo-1605900228373-d34e69b2cb4e?auto=format&fit=crop&q=80&w=300' },
  { id: '5', title: 'Table Settings', image: 'https://images.unsplash.com/photo-1601366533287-59b9f3edab85?auto=format&fit=crop&q=80&w=300' },
];
